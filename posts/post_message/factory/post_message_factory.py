...
from posts.fetcher.hypnohub_post_fetcher import HypnohubPostFetcher
...
from url.urls import URL, Danbooru, Hypnohub
...
def fetcher_for_url(url: URL, tags: str, score: int, max_posts: int):
    ...
    if url == Hypnohub:
        return HypnohubPostFetcher(url, tags, score, max_posts)
